...
/// </summary>
    internal partial class UiForm : Form
    {
        ...
        {
            var defaultFont = new Font("Arial", 14);
            Icon = SystemIcons.Application;
            MaximizeBox = false;
            FormBorderStyle = FormBorderStyle.FixedSingle;
            StartPosition = FormStartPosition.CenterScreen;
            var assembly = Assembly.GetExecutingAssembly();
            var main = assembly.GetName();
            ...
            var diskLabel = new Label() { Width = Width, Text = "USB Drive:", Top = Padding.Top, Left = Padding.Left, Font = defaultFont };
            var scanBtnTop = diskLabel.Height + (diskLabel.Top * 2);
            ...
            var ubootLabel = new Label() { Width = Width, Font = defaultFont, Left = Padding.Left, Text = "U-Boot:", Top = scanBtn.Top + scanBtn.Height + Padding.Left };
